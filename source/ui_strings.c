...
const Language_s language_italian = {
    ...
    .install_instructions =
    {
        .info_line = "\uE001 Annulla l'installazione del tema,
        .instructions = {
            {
    ...
    {
        {
            .info_line = "\uE001 Abbandona il menu di ordinamento",
            .instructions = {
                {
                    "\uE079 Ordina per nome",
                    "\uE07A Ordina per autore"
        ...
        {
            .info_line = "\uE001 Abbandona il menu extra",
            .instructions = {
                {
                    "\uE079 Vai nella lista",
                    "\uE07A Ricrarica icone temi corrotte"
                },
                {
                    "\uE07B Mostra ThemePlaza",
                    "\uE07C Scarica Badges"
        ...
        {
            .info_line = "\uE001 Abbandona il menu di clonazione",
            .instructions = {
                {
                    "\uE079 Clona i temi attuali",
                    "\uE07A Clona tutti i temi"
                },
                {
                    NULL,
    ...
    .draw = 
    {
        ...
        .switch_themes = "Or \uE004 to switch to themes",
        .quit = "Or        to quit",
        .start_pos = 1781, // Adjust x pos of start glyph to line up with quit string
        .by = "By ",
        .selected = "Selected:",
        .sel = "Sel.:",
        .tp_theme_mode = "ThemePlaza Theme mode",
